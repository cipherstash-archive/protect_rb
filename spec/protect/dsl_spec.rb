  ...
  describe "class_methods" do
    context "secure_search" do
      ...
      it "raises an error when secure_search has already been specified for an attribute" do
        ...
        }.to raise_error(CipherStash::Protect::Error, "Attribute 'dob' is already specified as a secure search attribute.")
      end
      ...
      context "when a secure_search attribute does not exist" do
        it "raises an error if there are no pending migrations" do
          ...
          }.to raise_error(CipherStash::Protect::Error, "Column name 'unicorn_secure_search' does not exist")
        end
    ...
    context "secure_text_search" do
      ...
      it "raises an error when secure_text_search has already been specified for an attribute" do
        ...
        }.to raise_error(CipherStash::Protect::Error, "Attribute 'full_name' is already specified as a secure text search attribute.")
      end
      ...
      it "raises an error when secure_text_search is specified on a non text attribute" do
        ...
        }.to raise_error(CipherStash::Protect::Error, "Attribute 'verified' is not a valid secure_text_search type. Attribute must be of type 'string' or 'text'.")
      end

      it "raises an error when secure_text_search attribute is not db data type 'smallint[]'" do
        expect {
          model.secure_text_search :email
        }.to raise_error(CipherStash::Protect::Error, "Column name 'email_secure_text_search' is not of type 'smallint[]' (in secure_text_search :email)")
      end
      ...
      context "when a secure_text_search attribute does not exist" do
        it "raises an error if there are no pending migrations" do
          ...
          }.to raise_error(CipherStash::Protect::Error, "Column name 'unicorn_secure_text_search' does not exist")
        end
