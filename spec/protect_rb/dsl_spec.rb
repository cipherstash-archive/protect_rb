RSpec.describe ProtectRB::Model::DSL do
  describe "class_methods" do
    context "secure_search" do
      it "raises an error when there are no lockbox attributes specified" do
        ...
        }.to raise_error(ProtectRB::Error, "Attribute 'unencrypted_data' is not encrypted by Lockbox.")
      end
      ...
      it "raises an error when a secure_search attribute is not of type :ore_64_8_v1" do
        ...
        }.to raise_error(ProtectRB::Error,  "Column name 'email_secure_search' is not of type :ore_64_8_v1 (in `secure_search :email`)")
      end

      it "raises an error when secure_search has already been specified for an attribute" do
        expect {
          DslTesting.secure_search :dob
        }.to raise_error(ProtectRB::Error, "Attribute 'dob' is already specified as a secure search attribute.")
      end
